  ...
  $.summernote = $.extend($.summernote, {
    ...
    options: {
      ...
      icons: {
        ...
        'rowBelow': 'note-icons-row-below',
        'colBefore': 'note-icons-col-before',
        'colAfter': 'note-icons-col-after',
        'rowAbove': 'note-icons-row-above',
        'rowRemove': 'note-icons-row-remove',
        'colRemove': 'note-icons-col-remove',
        ...
        'menuCheck': 'note-icons-menu-check',
