<template>
    <header class="site-header">
        <a href="#" class="brand-main">
            <img src="/assets/img/logo-desk.png" id="logo-desk" alt="Laraspace Logo" class="d-none d-md-inline">
            <img src="/assets/img/logo-mobile.png" id="logo-mobile" alt="Laraspace Logo" class="d-md-none">
        </a>
        ...
        <ul class="action-list">
            ...
            <li>
                ...
                <div class="dropdown-menu dropdown-menu-right notification-dropdown">
                    <router-link class="dropdown-item" to="/admin/settings"><i class="icon-fa icon-fa-cogs"></i> Settings</router-link>
                    <a href="#" class="dropdown-item" @click.prevent="logout"><i class="icon-fa icon-fa-sign-out"></i> Logout</a>
                </div>
            </li>
        </ul>
    </header>
