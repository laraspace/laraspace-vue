          ...
          <div class="card">
            ...
            <div class="card-body">
              <ol class="fc-event-list">
                <li><span class="fc-event-dot"/> Default</li>
                <li><span class="fc-event-dot fc-event-primary-dot"/> Primary</li>
                <li><span class="fc-event-dot fc-event-success-dot"/> Success</li>
                <li><span class="fc-event-dot fc-event-danger-dot"/> Danger</li>
                <li><span class="fc-event-dot fc-event-warning-dot"/> Warning</li>
              </ol>
            </div>
          </div>
        </div>
