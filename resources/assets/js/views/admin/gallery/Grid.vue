                ...
                <div class="my-gallery image-gallery" itemscope>
                    <div class="row">
                        <figure class="col-lg-3 col-md-6 col-xs-12" itemprop="associatedMedia" itemscope>
                            <a href="/assets/img/demo/gallery/1.jpg" itemprop="contentUrl"
                               data-size="480x360">
                                <img src="/assets/img/demo/gallery/1.jpg"
                                     itemprop="thumbnail" class="img-fluid" alt="Image description"/>
                            </a>
                            <figcaption itemprop="caption description">Image caption 1</figcaption>
                        </figure>
                        <figure class="col-lg-3 col-md-6 col-xs-12" itemprop="associatedMedia" itemscope>
                            <a href="/assets/img/demo/gallery/2.jpg" itemprop="contentUrl"
                               data-size="480x360">
                                <img src="/assets/img/demo/gallery/2.jpg"
                                     itemprop="thumbnail" class="img-fluid" alt="Image description"/>
                            </a>
                            <figcaption itemprop="caption description">Image caption 2</figcaption>
                        </figure>
                        <figure class="col-lg-3 col-md-6 col-xs-12" itemprop="associatedMedia" itemscope>
                            <a href="/assets/img/demo/gallery/3.jpg" itemprop="contentUrl"
                               data-size="480x360">
                                <img src="/assets/img/demo/gallery/3.jpg"
                                     itemprop="thumbnail" class="img-fluid" alt="Image description"/>
                            </a>
                            <figcaption itemprop="caption description">Image caption 3</figcaption>
                        </figure>
                        <figure class="col-lg-3 col-md-6 col-xs-12" itemprop="associatedMedia" itemscope>
                            <a href="/assets/img/demo/gallery/4.jpg" itemprop="contentUrl"
                               data-size="480x360">
                                <img src="/assets/img/demo/gallery/4.jpg"
                                     itemprop="thumbnail" class="img-fluid" alt="Image description"/>
                            </a>
                    ...
                    <div class="row">
                        <figure class="col-lg-3 col-md-6 col-xs-12" itemprop="associatedMedia" itemscope>
                            <a href="/assets/img/demo/gallery/5.jpg" itemprop="contentUrl"
                               data-size="480x360">
                                <img src="/assets/img/demo/gallery/5.jpg"
                                     itemprop="thumbnail" class="img-fluid" alt="Image description"/>
                            </a>
                            <figcaption itemprop="caption description">Image caption 1</figcaption>
                        </figure>
                        <figure class="col-lg-3 col-md-6 col-xs-12" itemprop="associatedMedia" itemscope>
                            <a href="/assets/img/demo/gallery/6.jpg" itemprop="contentUrl"
                               data-size="480x360">
                                <img src="/assets/img/demo/gallery/6.jpg"
                                     itemprop="thumbnail" class="img-fluid" alt="Image description"/>
                            </a>
                            <figcaption itemprop="caption description">Image caption 2</figcaption>
                        </figure>
                        <figure class="col-lg-3 col-md-6 col-xs-12" itemprop="associatedMedia" itemscope>
                            <a href="/assets/img/demo/gallery/7.jpg" itemprop="contentUrl"
                               data-size="480x360">
                                <img src="/assets/img/demo/gallery/7.jpg"
                                     itemprop="thumbnail" class="img-fluid" alt="Image description"/>
                            </a>
                            <figcaption itemprop="caption description">Image caption 3</figcaption>
                        </figure>
                        <figure class="col-lg-3 col-md-6 col-xs-12" itemprop="associatedMedia" itemscope>
                            <a href="/assets/img/demo/gallery/8.jpg" itemprop="contentUrl"
                               data-size="480x360">
                                <img src="/assets/img/demo/gallery/8.jpg"
                                     itemprop="thumbnail" class="img-fluid" alt="Image description"/>
                            </a>
                            <figcaption itemprop="caption description">Image caption 4</figcaption>
                        </figure>
                    ...
                    <div class="row">
                        <figure class="col-lg-3 col-md-6 col-xs-12" itemprop="associatedMedia" itemscope>
                            <a href="/assets/img/demo/gallery/9.jpg" itemprop="contentUrl"
                               data-size="480x360">
                                <img src="/assets/img/demo/gallery/9.jpg"
                                     itemprop="thumbnail" class="img-fluid" alt="Image description"/>
                            </a>
                            <figcaption itemprop="caption description">Image caption 1</figcaption>
                        </figure>
                        <figure class="col-lg-3 col-md-6 col-xs-12" itemprop="associatedMedia" itemscope>
                            <a href="/assets/img/demo/gallery/10.jpg" itemprop="contentUrl"
                               data-size="480x360">
                                <img src="/assets/img/demo/gallery/10.jpg"
                                     itemprop="thumbnail" class="img-fluid" alt="Image description"/>
                            </a>
                            <figcaption itemprop="caption description">Image caption 2</figcaption>
                        </figure>
                        <figure class="col-lg-3 col-md-6 col-xs-12" itemprop="associatedMedia" itemscope>
                            <a href="/assets/img/demo/gallery/11.jpg" itemprop="contentUrl"
                               data-size="480x360">
                                <img src="/assets/img/demo/gallery/11.jpg"
                                     itemprop="thumbnail" class="img-fluid" alt="Image description"/>
                            </a>
                            <figcaption itemprop="caption description">Image caption 3</figcaption>
                        </figure>
                        <figure class="col-lg-3 col-md-6 col-xs-12" itemprop="associatedMedia" itemscope>
                            <a href="/assets/img/demo/gallery/12.jpg" itemprop="contentUrl"
                               data-size="480x360">
                                <img src="/assets/img/demo/gallery/12.jpg"
                                     itemprop="thumbnail" class="img-fluid" alt="Image description"/>
                            </a>
                            <figcaption itemprop="caption description">Image caption 4</figcaption>
                        </figure>
