                    ...
                    <div class="my-gallery-container">
                        <div class="item" data-order="0">
                            <figure itemprop="associatedMedia" itemscope>
                                <a href="/assets/img/demo/gallery/1.jpg"
                                   itemprop="contentUrl" data-size="480x360">
                                    <img src="/assets/img/demo/gallery/1.jpg" itemprop="thumbnail"
                        ...
                        <div class="item" data-order="1">
                            <figure itemprop="associatedMedia" itemscope>
                                <a href="/assets/img/demo/gallery/14.jpg" itemprop="contentUrl"
                                   data-size="480x757">
                                    <img src="/assets/img/demo/gallery/14.jpg"
                        ...
                        <div class="item" data-order="3">
                            <figure itemprop="associatedMedia" itemscope>
                                <a href="/assets/img/demo/gallery/17.jpg" itemprop="contentUrl"
                                   data-size="480x720">
                                    <img src="/assets/img/demo/gallery/17.jpg"
                                         itemprop="thumbnail" class="img-fluid" alt="Image description"/>
                                </a>
                            </figure>
                        </div>
                        <div class="item" data-order="4">
                            <figure itemprop="associatedMedia" itemscope>
                                <a href="/assets/img/demo/gallery/15.jpg" itemprop="contentUrl"
                                   data-size="480x720">
                        ...
                        <div class="item" data-order="6">
                            <figure itemprop="associatedMedia" itemscope>
                                <a href="/assets/img/demo/gallery/16.jpg" itemprop="contentUrl"
                                   data-size="480x720">
                        ...
                        <div class="item" data-order="7">
                            <figure itemprop="associatedMedia" itemscope>
                                <a href="/assets/img/demo/gallery/18.jpg" itemprop="contentUrl"
                                   data-size="480x270">
                                    <img src="/assets/img/demo/gallery/18.jpg"
                                         itemprop="thumbnail" class="img-fluid" alt="Image description"/>
                                </a>
                            </figure>
                        </div>
                        ...
                        <div class="item" data-order="9">
                            <figure itemprop="associatedMedia" itemscope>
                                <a href="/assets/img/demo/gallery/13.jpg" itemprop="contentUrl"
                                   data-size="480x720">
