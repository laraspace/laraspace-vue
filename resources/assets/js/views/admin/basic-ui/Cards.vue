      ...
      <div class="card-body">
        ...
        <div class="row">
          ...
          <div class="col-sm-6">
            <div class="card">
              <div class="card-header">
                <h6><i class="icon-fa icon-fa-star"/> Card With Icon</h6>
              </div>
              <div class="card-body">
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                Alias enim excepturi exercitationem ipsum labore provident quam ut velit vero
          ...
          <div class="col-sm-6">
            <div class="card">
              <div class="card-header bg-primary">
                <h6><i class="icon-fa icon-fa-star"/> Primary</h6>
              </div>
              <div class="card-body">
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                Alias enim excepturi exercitationem ipsum labore provident quam ut velit vero
          ...
          <div class="col-sm-6">
            <div class="card">
              <div class="card-header bg-info">
                <h6><i class="icon-fa icon-fa-info"/> Info</h6>
              </div>
              <div class="card-body">
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                Alias enim excepturi exercitationem ipsum labore provident quam ut velit vero
          ...
          <div class="col-sm-6">
            <div class="card">
              <div class="card-header bg-danger">
                <h6><i class="icon-fa icon-fa-ambulance"/> Danger</h6>
              </div>
              <div class="card-body">
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                Alias enim excepturi exercitationem ipsum labore provident quam ut velit vero
          ...
          <div class="col-sm-6">
            <div class="card">
              <div class="card-header bg-warning">
                <h6><i class="icon-fa icon-fa-warning"/> Warning</h6>
              </div>
              <div class="card-body">
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                Alias enim excepturi exercitationem ipsum labore provident quam ut velit vero
          ...
          <div class="col-sm-6">
            <div class="card">
              <div class="card-header bg-success">
                <h6><i class="icon-fa icon-fa-check"/> Success</h6>
              </div>
              <div class="card-body">
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                Alias enim excepturi exercitationem ipsum labore provident quam ut velit vero
          ...
          <div class="col-sm-6">
            <div class="card">
              <div class="card-header bg-dark">
                <h6><i class="icon-fa icon-fa-cube"/> Dark</h6>
              </div>
              <div class="card-body">
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                Alias enim excepturi exercitationem ipsum labore provident quam ut velit vero
