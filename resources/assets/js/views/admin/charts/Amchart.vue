    ...
    export default {
        mounted() {
            ...
            let AMCharts = function () {
                return {
                    ...
                    init: function () {
                        vm.handleColumnAndLineChart();
                        vm.handleClusterBarChart();
                        vm.handleDurationOnValueAxisChart();
                        vm.handleStackAreaChart();
                        vm.handle3dCylinderChart();
                        vm.handleAnimatedTimeLinePieChart();
                        vm.handle3dDonutChart();
                        vm.handleRadarChart();
                        vm.handlePolarScatterChart();
                        vm.handleAnimationsAlongLinesMap();
                        vm.handleCapitalsMap();
        ...
        methods: {
            handleColumnAndLineChart() {
                var columnAndLineChart = window.AmCharts.makeChart("bar-line-chart", {
                    "type": "serial",
                    "addClassNames": true,
                    "theme": "light",
                    "autoMargins": false,
            ...
            handleClusterBarChart() {
                var clusterBarChart = window.AmCharts.makeChart("clust-bar-chart", {
                    "type": "serial",
                    "categoryField": "year",
                    "theme": "light",
                    "rotate": true,
            ...
            handleDurationOnValueAxisChart() {
                ...
                var durationOnValueAxisChart = window.AmCharts.makeChart("line-area-value-axis", {
                    "type": "serial",
                    "theme": "none",
                    "theme": "light",
                    "legend": {
            ...
            handleStackAreaChart() {
                var stackAreaChart = window.AmCharts.makeChart("stack-area-chart", {
                    "type": "serial",
                    "theme": "none",
                    "theme": "light",
                    ...
                    "graphs": [{
                        "balloonText": "" +
                        "<img src='/assets/img/charts/car.png' style='vertical-align:bottom; " +
                        ...
                        "balloonText": "" +
                        "<img src='/assets/img/charts/motorcycle.png' style='vertical-align:bottom;" +
                        " margin-right: 10px; width:28px; height:21px;'><span style='font-size:14px; color:#000000;'>" +
                        "<b>[[value]]</b></span>",
                        "fillAlphas": 0.6,
                        "lineAlpha": 0.4,
                        ...
                        "balloonText": "" +
                        "<img src='/assets/img/charts/bicycle.png' style='vertical-align:bottom; " +
                        "margin-right: 10px; width:28px; height:21px;'><span style='font-size:14px; color:#000000;'>" +
                        "<b>[[value]]</b></span>",
                        "fillAlphas": 0.6,
                        "lineAlpha": 0.4,
            ...
            handle3dCylinderChart() {
                ...
                var cylinderChart = window.AmCharts.makeChart("3d-cylinder-chart", {
                    "theme": "light",
                    "type": 'serial',
                    "startDuration": 2,
                    "dataProvider": [{
            ...
            handleAnimatedTimeLinePieChart() {
                ...
                var animatedTimeLinePieChart = window.AmCharts.makeChart("animated-pie-chart", {
                    "type": "pie",
                    "theme": "light",
                    "dataProvider": [],
                    "valueField": "size",
            ...
            handleRadarChart() {
                ...
                var radarchart = window.AmCharts.makeChart("radar-chart", {
                    "type": "radar",
                    "theme": "light",
                    "dataProvider": [{
            ...
            handlePolarScatterChart() {
                var polarScatterChart = window.AmCharts.makeChart("polar-scatter-chart", {
                    "type": "radar",
                    "theme": "light",
                    "dataProvider": [],
                    "valueAxes": [{
            ...
            handleCapitalsMap() {
                 ...
                 * Create the map
                 */
                var capitalsMap = window.AmCharts.makeChart("capital-map-chart", {
                    "type": "map",
                    "projection": "winkel3",
                    "theme": "light",
                    "imagesSettings": {
            ...
            handleMultipleDataSetsStockChart() {
                ...
                var multipleDataSetsStockChart = window.AmCharts.makeChart("multiple-data-sets-chart", {
                    "type": "stock",
                    "theme": "light",
                    "pathToImages": "/assets/img/charts/",
                    "dataSets": [{
