    ...
    <div class="card">
      ...
      <div class="card-body">
        <div class="content">
          <form
            id="basic-wizard-2"
            class="form-wizard-1 icon-wizard">
            <h3><i class="icon-fa icon-fa-home"/>Step 1</h3>
            <section>
              <div class="row">
                <div class="col-lg-6">
                  <div class="form-group">
            ...
            <h3><i class="icon-fa icon-fa-key"/>Step 2</h3>
            <section>
              <div class="row">
                <div class="col-lg-6">
                  <div class="form-group">
            ...
            <h3><i class="icon-fa icon-fa-map-marker"/>Step 3</h3>
            <section>
              <div class="row">
                <div class="col-lg-6">
                  <div class="form-group">
            ...
            <h3><i class="icon-fa icon-fa-twitter"/>Step 4</h3>
            <section>
              <div class="form-group">
                <label>Facebook</label>
                <input
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <input
                        ...
                        id="dob"
                        name="dob"
                        class="form-control required ls-datepicker"
                        value="06/10/2017">
                      <div class="input-group-append">
                        <span class="input-group-text">
                          <i class="icon-fa icon-fa-calendar"/>
